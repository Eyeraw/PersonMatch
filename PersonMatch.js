		...
		if(iCount > 0){
			if(inSiebel == false && inSiebelInn == false && inSiebelMatch == false && inSiebelPhone == false){ //ONikitushkina 15.01.2018 CR-788
				...
				for(var i = 0; i < iCount; i++){
					...
					sTemp = "";
					oFindedMatchPS.SetProperty(oOutputPS.GetChild(i).GetProperty("Matchee Row Id"), oOutputPS.GetChild(i).GetProperty("Score"));
					sTemp = "[Contact.Id]='" + oOutputPS.GetChild(i).GetProperty("Matchee Row Id") + "'";				
